...
function AccountingEntry({ title }) {
    ...
    console.log('data', dataListAccountEntryDetail);
    ...
    OnMultiKeyEvent(handleOnClickNewAeHeader, 'n');
    OnMultiKeyEvent(handleOnClickUpdateAeHeader, 'u');
    OnMultiKeyEvent(handleClickSave, 's');
    OnMultiKeyEvent(handleOnClickDeleteAeHeader, 'd');
    OnMultiKeyEvent(handleClickOpenDialogDetail, 'a');
    // OnMultiKeyEvent(handleOnClickNewAeDetail, 'a');
                                                        ...
                                                        <Stack spacing={0}>
                                                            <div style={{ width: '100%', minHeight: 500 }}>
                                                                <DataGrid
                                                                    ...
                                                                    onRowDoubleClick={() => setOpenDialogDetail(true)}
                                                                    slotProps={{
                                                                        baseSelect: {
                                                                            MenuProps: {
                                                                                PaperProps: {
